...
(function() { this.JST || (this.JST = {}); this.JST["profiles/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3>',  profile.escape('username') ,'</h3>\n<img class="index-item-photo" src="',  profile.escape('photo_url'),'">\n');}return __p.join('');};
}).call(this);
