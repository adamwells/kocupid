...
(function() { this.JST || (this.JST = {}); this.JST["profiles/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1> Profiles Index </h1>\n\n<ul class="profiles-index"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["profiles/index_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h3><a href="#/profiles/',  profile.id ,'">',  profile.escape('username') ,'</a></h3>\n<img class="index-item-photo" src="',  profile.escape('photo_url'),'">\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["profiles/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>',  profile.escape('self_summary') ,'</h1>\n');}return __p.join('');};
}).call(this);
